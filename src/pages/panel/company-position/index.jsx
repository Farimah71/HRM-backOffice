...
export const CompanyPosition = () => {
  ...
  const cols = [
    ...
    },
    {
      ...
      selector: (row) => (
        <p className="dark:text-dark_custom-full-white">{row.positionDetail}</p>
      ),
    },
    {
      name: t("table.col.salary_range"),
      selector: (row) => (
        <p className="dark:text-dark_custom-full-white">{row.salaryRange}</p>
      ),
    },
    {
          ...
          filters: [
            {
              ...
              operation: 5,
              values: [
                `${state?.companyId ? state.companyId : navigate("/company")}`,
              ],
            },
          ],
          orderBy: "",
          includeProperties:
            "CompanyPositionExpertides,CompanyPositionFeatures",
        }
      : {
          pageNumber: 0,
          pageSize: 0,
          filters: [
            {
              property: "CompanyProjectId",
              operation: 5,
              values: [
                `${
                  state?.companyProjectId
                    ? state.companyProjectId
                    : navigate("/company")
                }`,
              ],
