        ...
        {expertiseData && !expertiseLoading ? (
          expertisesFilter.map((expertise) =>
            expertisesSelected.findIndex(
              ...
              <div className="p-3 bg-custom-gray-light rounded-xl cursor-default text-14 opacity-50 dark:dark:bg-dark_custom-light-black dark:text-dark_custom-full-white">
                {expertise.title}
              </div>
            )
          )
