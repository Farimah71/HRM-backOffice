...
export const CreateCountry = ({ onCloseModal, isReloadPage }) => {
  // ---------- store ----------
  const loading = useSelector((state) => state.countrySlice.loading);
  ...
  useEffect(() => {
    if (languageData.count) {
      setSelectOptions((prevState) => ({
        ...prevState,
        language: convertArrayToSelectOptions(languageData.data, [
          "id",
          "title",
        ]),
      }));
  ...
  useEffect(() => {
    if (currencyData.count) {
      setSelectOptions((prevState) => ({
        ...prevState,
        currency: convertArrayToSelectOptions(currencyData.data, [
          "id",
          "title",
        ]),
      }));
