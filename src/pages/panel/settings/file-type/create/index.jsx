...
import { createFileType } from "../../../../../redux/actions/settings/file-type";
import * as Yup from "yup";

export const CreateFileType = ({ onCloseModal, isReloadPage, loading }) => {
  // ---------- hooks ----------
  ...
  const onSubmit = (values) => {
    dispatch(createFileType(values, (status) => reloadPageHandler(status)));
  };
