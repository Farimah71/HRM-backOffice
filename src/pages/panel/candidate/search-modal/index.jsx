...
export const SearchModal = ({ infoCandidate, onCloseModal, onClick }) => {
  // ---------- hooks ----------
  ...
  return (
    <>
      ...
      <div className="overflow-y-auto">
        {infoCandidate.map((candidate) => (
          <div
            className="p-4 [&:not(:last-child)]:border-b [&:not(:last-child)]:border-b-custom-gray-light"
            key={candidate.id}
          >
            ...
            <div className="mt-8 flex items-start gap-4 flex-wrap">
              {candidate.candidatePositions.length ? (
                candidate.candidatePositions.map((candidatePosition) => (
                  <div
                    key={candidatePosition.id}
                    className="rounded-md border-2 border-custom-gray-light py-2 px-4 flex flex-col items-start gap-y-2 w-52"
                  >
